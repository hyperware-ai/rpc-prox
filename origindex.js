...
const targetWsUrl = 'wss://optimism-mainnet.infura.io/ws/v3/d449da9257d848298e5e63fcd03a45b6';
...
wss.on('connection', (clientSocket, req) => {
  ...
  targetSocket.on('message', (message) => {
    try {
      console.log("Got a message from the target.")    
      let decodedMessage = message.toString();
